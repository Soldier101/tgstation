...
/obj/machinery/dna_scannernew/MouseDrop_T(mob/target, mob/user)
	...
	if(user.stat || (isliving(user) && (!(L.mobility_flags & MOBILITY_STAND) || !(L.mobility_flags & MOBILITY_UI))) || !(user.mobility_flags & MOBILITY_UI) || !Adjacent(user) || !user.Adjacent(target) || !iscarbon(target) || !user.IsAdvancedToolUser())
		return
